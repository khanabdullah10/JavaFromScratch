...
public class MusicLibrary {
    private String song;
    private static List<MusicLibrary> playlist = new ArrayList<>(); // Initialize the playlist statically

    public MusicLibrary() {
        // No need to initialize playlist here, it's already statically initialized
    }
    ...
    public static void main(String[] args) {
        ...
        item1.addSong(item1);
        item2.addSong(item2); // Corrected from item1 to item2
        item3.addSong(item3); // Corrected from item1 to item3
        item4.addSong(item4); // Corrected from item1 to item4
        System.out.println();
